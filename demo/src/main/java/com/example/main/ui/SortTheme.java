...
final class SortTheme {
    static final String DEFAULT_BAR = "#4F46E5";
    static final String COMPARE_BAR = "#F59E0B";
    static final String SWAP_BAR = "#EF4444";
    ...
    static final String SECONDARY_BUTTON = "btn-secondary";
